...
class EditService extends StatefulWidget {
  ...
  final Product product;
   EditService({required this.service,required this.product,super.key});
                            ...
                            Container(
                              ...
                              child: ElevatedButton(
                                onPressed: () async {
                                  ...
                                  String serviceImage = selectedImage!=null?await uploadFile():productImage!;
                                bool check= await ServiceController().updateService(
                                      serviceId,
                                      serviceName,
                                      {
